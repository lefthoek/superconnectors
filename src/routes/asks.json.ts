export const get = () => {
	return {
		body: [
			...
			{ team: 'Savvy Store', summary: 'Help with Funding, Marketing, and PR', points: 40 },
			{ team: 'Addoptics', summary: 'Find Informal Investor', points: 68 },
			{
				team: 'Moonback',
				summary: 'Introductions Destination Marketing Organizations',
				points: 72
			},
			{ team: 'Bereik', summary: 'Set up Development Office Barcelona', points: 55 },
			{ team: 'Skoon World', summary: 'Introduction Energy Related Organizations', points: 48 }
		]
	};
};
